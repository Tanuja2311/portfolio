...
export const AI_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    thumbnailAlt: "Screenshot of the live Triibe100 page at triibe.org/100, the grid of 100 honorees shown in a browser frame",
    coverColor:   "#111111",
...
export const OTHER_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    coverColor:     "#0d1a0f",
    stat:           "Most driveway rental platforms optimize for bookings. UrbanPark was designed around what homeowners actually fear.",
